...
public class c1_Introduction extends IntroductionBase {
    ...
    public void hello_world() {
        ...
        String result = serviceResult.blockOptional().orElse("Hello World!"); //todo: change this line only
    ...
    public void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            String result = serviceResult.timeout(Duration.ofSeconds(1L))
                    .blockOptional()
                    .orElseThrow(() -> new IllegalStateException("Timeout on blocking read for 1")); //todo: change this line only
        });
